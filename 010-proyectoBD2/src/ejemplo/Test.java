...
public class Test {
    ...
    public static void main(String[] args) throws Exception{
        ...
        Usuario usuario = new Usuario("Pedro","pedro@digital.com",10d);

        Connection connection = null;//primero null porque se va a crear
        ...
        try{
            ...
            //como se empieza la transaccion se usa el autocommit
            ...
            psUpdate.execute();
            //luego se prueba un error
            int a = 4/0;
            ///
            connection.commit();

            connection.setAutoCommit(true);//buena practica
    ...
    private static Connection getConnection() throws Exception {
        ...
        return DriverManager.getConnection("jdbc:h2:"
                + "C:\\Users\\Karol\\Desktop\\BACKEND1\\010-proyectoBD2\\database\\ejemplo1", "sa", "");
    }
